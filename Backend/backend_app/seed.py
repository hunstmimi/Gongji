...
CABINET_SEEDS = [
    ...
    CabinetSeed("10.20.12.226-3090", "位置1", "3090", "单卡机柜", 1, 1.9, 1.7, "available", "10.20.12.226"),
    ...
    CabinetSeed("10.21.53.113-4090", "位置3", "4090", "单卡机柜", 1, 2.5, 2.1, "available", "10.21.53.113"),
